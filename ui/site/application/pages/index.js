  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2 bg-custom-color-3">
      ...
      <main className="flex flex-col items-center justify-center w-full flex-l px-20 text-center m-4">
        ...
        <form className='flex flex-col items-center justify-center w-full flex-l text-center m-4 h-auto'>
          <div className='w-3/5 p-5 text-white' >{/* Sing in*/}
              ...
              <div className='flex-col flex items-center'>
                ...
                <div className='bg-custom-color-3 w-64 p-2 text-white flex items-center mb-3 shadow-2xl'>
                  ...
                  <input type="email"  name="email" id="email" placeholder='Email' className='bg-custom-color-3 outline-none text-sm flex-1'></input>
                </div>
              </div>
              ...
              <div className='flex-col flex items-center'>
                <div className='bg-custom-color-3 w-64 p-2 text-white flex items-center shadow-2xl'>
                  ...
                  <input type="password"  name="password" id='password' placeholder='Senha' className='bg-custom-color-3 outline-none text-sm flex-1'></input>
                </div>
              </div>
              <a href="/login" className='border-4 border-custom-color-3 rounded-full px-12 py-2 inline-block font-semibold mt-6 hover:bg-custom-color-3 '>Login</a>
            </div>          
          </form>
